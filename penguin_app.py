...
if st.sidebar.button("Predict"):
  if classifier == 'Support Vector Machine':
    species_type = prediction(svc_model, bill_len, bill_wid, flipper_len, body_mass)
    score = svc_model.score(X_train, y_train)

  elif classifier =='Logistic Regression':
    species_type = prediction(log_reg, bill_len, bill_wid, flipper_len, body_mass)
    score = log_reg.score(X_train, y_train)

  else:
    species_type = prediction(rf_clf,  bill_len, bill_wid, flipper_len, body_mass)
